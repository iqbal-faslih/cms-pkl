...
import { usePostsByTag } from "../hooks/usePostByTag";

const TagPage = () => {
  const { tagName } = useParams();
  const { posts, loading, error } = usePostsByTag(tagName);
        ...
        <main className="lg:col-span-2">
          <div className="bg-white p-6 rounded-2xl shadow-md mb-8">
            <h1 className="text-3xl font-bold mb-4">
              Postingan dengan Tag: <span className="text-blue-600 capitalize">{tagName}</span>
            </h1>
