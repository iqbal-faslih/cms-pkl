...
export default function JamKantorCabang() {
  const sessions = [
  ...
  return (
    <div className="flex min-h-screen bg-[#ECF2FF] font-sans">
      <main className="flex-1 p-2">
        {/* banner */}
        <div className="bg-sky-800 text-white px-5 rounded-xl mb-8 flex justify-between items-center">
          <div>
            <p className="text-lg font-semibold">Selamat Pagi Mr. Gojo!</p>
            <p className="text-[12px]">Anda Berada di halaman cabang Malang</p>
          </div>
...
const SessionCard = ({ title, total }) => {
  return (
    <div className="bg-white rounded-xl p-4 shadow-md/30 transition">
      ...
      <Link
        to={`/cabang/jam-kantor-sesi?sesi=${title}`}
