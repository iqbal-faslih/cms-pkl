...
import { RfidCabangConfig } from "./RfidCabangConfig";
...
import { usePesertaOptions } from "./hooks/usePesertaOptions";
import { getRfidFields } from "./Fields";
import { useRfidActions } from "./hooks/useRfidActions";
...
export default function RfidCabangPage() {
  ...
  const { options: pesertaOptions, loading: pesertaLoading } =
    usePesertaOptions(isTambahOpen);
  ...
  return (
    <div className="bg-white rounded-2xl p-4">
      ...
      <FormModal
        ...
        initialValues={{ rfidSiswa: editData?.rfid_code || "", idPeserta: editData?.id }}
